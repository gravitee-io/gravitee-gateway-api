 ...
 */
public interface A2AProxyEndpointSyncConnectorFactory<T extends A2AProxyEndpointSyncConnector> extends HttpEndpointConnectorFactory<T> {
    @Override
    default Set<ConnectorMode> supportedModes() {
        return A2AProxyEndpointSyncConnector.modes();
    }

    @Override
    default ApiType supportedApi() {
        return A2AProxyEndpointSyncConnector.apiType();
    }
}
