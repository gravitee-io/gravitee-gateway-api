...
/**
 * Represents a response that can manipulate a flow of messages that is mapped from a Mqtt native FetchResponse.
 *
 *  @author Jeoffrey HAEYAERT (jeoffrey.haeyaert at graviteesource.com)
 *  @author GraviteeSource Team
 */
public interface MqttMessageResponse {
    /**
     ...
     *
     * @return a {@link Flowable} of {@link MqttMessage}.
     */
    Flowable<MqttMessage> messages();
     ...
     */
    void messages(final Flowable<MqttMessage> messages);
     ...
     */
    Completable onMessages(final FlowableTransformer<MqttMessage, MqttMessage> onMessages);
     ...
     * @return a {@link Completable} that completes once the message transformation has been set up on the message flow (not executed).
     */
    default Completable onMessage(Function<MqttMessage, Maybe<MqttMessage>> onMessage) {
