...
/**
 * Specialized {@link HttpEndpointConnector} for {@link ApiType#MESSAGE}
 */
public abstract class HttpEndpointAsyncConnector extends AbstractService<Connector> implements HttpEndpointConnector, EndpointConnector {
    ...
    public Completable connect(ExecutionContext ctx) {
        return connect((HttpExecutionContext) ctx);
    }
    ...
    public abstract Completable subscribe(final HttpExecutionContext ctx);

    public abstract Completable publish(final HttpExecutionContext ctx);
}
